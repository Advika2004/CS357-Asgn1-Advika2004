...
int main(void) {
    test01();
    printf("test01 has worked, hurrah! \n");
    test02();
    printf("OK BEAST test02 well done! \n");
    test03();
    printf("domain is expanding. test03 has passed. \n");
    test04();
    printf("and thats on period purr test04 passed. \n");
    test05();
    printf("test05. halfway boss. \n");
    test06();
    printf("test06 woo woo! \n");
    test07();
    printf("test01 has worked, hurrah! \n");
    test08();
    printf("test08 slayed. \n");
    test09();
    printf("test09 the universe is on your side. \n");
    test10();
    printf("test10 LFG. \n");
